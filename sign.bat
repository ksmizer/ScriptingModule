...
CALL java -jar target/module-signer-1.0.0-jar-with-dependencies.jar -keystore=keystore.jks -keystore-pwd=%arg2% -alias=%arg1% -alias-pwd=%arg2% -chain=certificateChain.p7b -module-in=../lego-module-build/target/Lego-Collector-unsigned.modl -module-out=../lego-module-build/target/Lego-Collector-signed.modl
del *.crt
del *.jks
del *.p7b